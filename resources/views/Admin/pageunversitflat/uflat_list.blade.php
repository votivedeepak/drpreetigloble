                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                               ...
                               <!--  <a href="{{ url('admin/add_uflat') }}" type="button" class="btn btn-warning waves-effect">Add University Flat </a> -->
                                              ...
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/edituflat')}}/{{$v->un_pid }}" class=" waves-effect waves-block">Edit</a></li>
