                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                                ...
                                <a href="{{ url('admin/add_toppsub') }}" type="button" class="btn btn-warning waves-effect">Add Sub Scope</a>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$v->t_heading}}</td>        											
                                            <td>{{$v->tps_heading}}</td>                                   
                                            <td>{{$v->tps_subheading}}</td>
                                            <td>                                           
                                            <label for="{{$v->tpsub_id}}"></label>
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/edittoppsub')}}/{{$v->tpsub_id}}" class=" waves-effect waves-block">Edit</a></li>
												   <li><a  href="{{url('admin/deletetoppsub').'/'.$v->tpsub_id}}" onClick="return confirm('Are you sure you want to delete this item?');" class=" waves-effect waves-block">Delete</a></li> 
