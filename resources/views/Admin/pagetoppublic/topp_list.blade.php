                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                                ...
                                <a href="{{ url('admin/add_topp') }}" type="button" class="btn btn-warning waves-effect">Add Top Public </a>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}}</td>                                       
                                             <td>{{$v->t_heading}}</td> 
											  <td>{{$v->t_subheading}}</td> 
                                        
                                            <td>                                           
                                            <label for="{{ $v->tp_id }}"></label>
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/edittopp')}}/{{$v->tp_id }}" class=" waves-effect waves-block">Edit</a></li>
												   <li><a  href="{{url('admin/deletetopp').'/'.$v->tp_id }}" onClick="return confirm('Are you sure you want to delete this item?');" class=" waves-effect waves-block">Delete</a></li> 
