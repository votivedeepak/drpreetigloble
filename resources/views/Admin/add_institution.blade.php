...
<body class="theme-red">
  ...
  <section class="content">
                        ...
                        <div class="row clearfix">
                         ...
                         <div class="col-sm-6">
							 ...
							 <div class="row clearfix">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        <input type="text" class="form-control" name="whatapplink" id="whatapplink" value="{{isset($universitydata->whatapplink)?$universitydata->whatapplink:''}}">                                      
                                        <label class="form-label">Link grup de whatsapp</label>
                                        @if($errors->has("whatapplink"))
                                        <span class="invalid-feedback d-block" role="alert" style="color: red;">
                                        <strong>{{$errors->first('whatapplink')}}</strong>
                                        </span>
                                        @endif
                                       </div> 
                                    </div>
                               ...
                               <div class="form-group form-float" id="genral">
								 ...
								 <div class="col-sm-6">
								   ...
								   <div class="col-sm-6">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <input type="file" class="form-control" name="degree_satisfaction">
										 <input type="hidden" class="form-control" name="degree_satisfaction_old" value="{{isset($universitydata->institution_degree_satisfaction)?$universitydata->institution_degree_satisfaction:''}}">
								  ...
								  <div class="col-sm-6">
                                    ...
                                    <div class="form-line">
							            ...
							            <input type="hidden" class="form-control" name="degree_access_old" value="{{isset($universitydata->institution_degree_access)?$universitydata->institution_degree_access:''}}">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">            
                                    <label class="form-label-op text-panel-name">Presentaciò de l'assignatura</label>                            
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">         
                                    <label class="text-panel-name">Objectius de l’estudi</label><br>                              
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">            
                                    <label class="text-panel-name">Què podre fer desprès</label>  <br>                           
                                    ...
                                    <div class="form-group form-float">
                                    <div class="form-line"> 
                                    <label class="text-panel-name">Address</label>
                                        <br>                                      
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        ...
                                        <label class="form-label text-panel-name">Univercity Url</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        ...
                                        <label class="form-label text-panel-name">Sub University degree</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        ...
                                        <label class="form-label text-panel-name">Text 1</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        ...
                                        <label class="form-label text-panel-name">Text 2</label>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">                                       
                                        ...
                                        <label class="form-label text-panel-name">Text 3</label>
                                ...
                                <div class="col-sm-6 ">
                                	<div class="form-group"> 
                                    <label class="form-label">Ponderacions d'assignatures de la Fase Específica de PAU</label>
                                    <div class="form-line">    
                                ...
                                <div class="row clearfix">
								   <div class="col-sm-6">
								    ...
								    <div class="col-sm-6">
									   <a href="javascript: void(0)" class="btn btn-primary waves-effect" id="addcontentid" onclick="showdataimage(2)">Add Content</a>
                     <input type="button" value="Add Content" class="btn btn-primary waves-effect add-right" id="add_button" style="display: none;"  onclick="addRow()">
								   </div>
							    </div>
                                <div class="form-group form-float col-md-12" id="image">
                      ...
                      <div class="col-md-12 field_wrapper_attraction " id="dropdown" style="display:none; margin-bottom: 0px;">
                        <div class="form-group" id="attraction">
                        <label class="mr-2titl text-panel-name"> Title</label>
                          <!-- <input type="button" value="Add More" class="btn btn-primary waves-effect add-right" id="dropdown" onclick="addRow()"> -->
                          ...
                          <div class="col-md-12" >
                            <div class="row">
                              <div class="col-md-12 form-group" style="padding: 0px;">
                                <input type="text" class="form-control add-title-in mt-3aw" name="title[]" placeholder="Enter Name" value="{{isset($value)?$value:''}}" />
                              </div>
                             ...
                             <div class="col-md-12 p-0" style="padding: 0px;">
                               <div class="row">
                                 <div class="col-md-12 form-group p-0">
                                   <input type="text" class="form-control add-title-in mt-3aw" name="title[]" placeholder="Enter title" value="" />
                                 </div>
                                 <!-- <div class="col-md-6 form-group">
                                   <input type="text" class="form-control" name="sub_title[]" placeholder="Enter sub title" value="" />
                                 </div> -->
                                 <div class="col-md-12 form-group p-0">
                                   <textarea class="form-control ckeditor" cols="60" rows="20" name="distribution[]" placeholder="Enter Content" value="" /></textarea>
                                 </div>
                               </div>
                             </div> 
    ...
    <div class='col-md-12 p-0' style="display: none;" id="ckeditords1"><div class='row'><div class='col-md-12 form-group'><input type='text' class='form-control add-title-in' name='title[]' placeholder='Enter Title' value=''/></div><div class='col-md-12 form-group'><textarea class='form-control ckeditor' cols="60" rows="20" id='ckeditor1' name='distribution[]' placeholder='Enter Content' value='' /></textarea></div><input type='button' class='btn btn-danger remove-margin' value='Remove' onclick='removeRow(this)'></div></div>

     <div class='col-md-12 ' style="display: none;" id="ckeditords2"><div class='row'><div class='col-md-12 form-group'><input type='text' class='form-control add-title-in' name='title[]' placeholder='Enter Title' value=''/></div><div class='col-md-12 form-group'><textarea class='form-control ckeditor' cols="60" rows="20" id='ckeditor2' name='distribution[]' placeholder='Enter Content' value='' /></textarea></div><input type='button' class='btn btn-danger remove-margin' value='Remove' onclick='removeRow(this)'></div></div>

     <div class='col-md-12' style="display: none;" id="ckeditords3"><div class='row'><div class='col-md-12 form-group'><input type='text' class='form-control add-title-in' name='title[]' placeholder='Enter Title' value=''/></div><div class='col-md-12 form-group'><textarea class='form-control ckeditor' cols="60" rows="20" id='ckeditor3' name='distribution[]' placeholder='Enter Content' value='' /></textarea></div><input type='button' class='btn btn-danger remove-margin' value='Remove' onclick='removeRow(this)'></div></div>
     
      <div class='col-md-12' style="display: none;" id="ckeditords4"><div class='row'><div class='col-md-12 form-group'><input type='text' class='form-control add-title-in' name='title[]' placeholder='Enter Title' value=''/></div><div class='col-md-12 form-group'><textarea class='form-control ckeditor' cols="60" rows="20" id='ckeditor4' name='distribution[]' placeholder='Enter Content' value='' /></textarea></div><input type='button' class='btn btn-danger remove-margin' value='Remove' onclick='removeRow(this)'></div></div>
<!--       
    ...
    <div class="w-100 text-center"> <input type="submit" value=" @if(empty($universitydata)) Add @else Update @endif " name="submit" class="btn btn-primary waves-effect mt-right-btn">
                             </div>
 ...
 <!-- <script>function addRow () {
  document.querySelector('#content').insertAdjacentHTML(
    ...
    <div class="col-md-6 form-group">
     <input type="text" class="form-control" name="sub_title[]" placeholder="Enter Name" value="" />
      </div>
    <div class="col-md-6 form-group">
    <input type="text" class="form-control ckeditor" name="distribution[]" placeholder="Enter Content" value="" />
    </div>
    <input type="button" class="btn btn-success" value="Remove" onclick="removeRow(this)">
    </div>
    </div>`  
