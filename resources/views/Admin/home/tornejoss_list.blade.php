                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                                 ...
                                 <a href="{{ url('admin/add_htournaments') }}" type="button" class="btn btn-warning waves-effect">Add Home Page Tournaments </a> 
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$i}}</td>                                       
                                             <td> <?php  if(!empty($v->t_image)){ ?>
										   <img src="{{ url('public') }}/images/home/{{$v->t_image}}" width="80" height="80" >
										     <?php } ?>	</td>
                                             <td>{!! $v->title !!}</td> 
                                             <td>{!! $v->description !!}</td> 											 
											                                        
                                            <td>                                           
                                            <label for="{{ $v->ht_id }}"></label>
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/edithtournaments')}}/{{$v->ht_id }}" class=" waves-effect waves-block">Edit</a></li>
                                                    <li><a  href="{{url('admin/deletehtournaments').'/'.$v->ht_id}}" onClick="return confirm('Are you sure you want to delete this item?');" class=" waves-effect waves-block">Delete</a></li> 
