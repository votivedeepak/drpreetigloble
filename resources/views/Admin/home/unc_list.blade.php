                           ...
                           University Category List
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                                ...
                                <a href="{{ url('admin/add_unccat') }}" type="button" class="btn btn-warning waves-effect">Add University Category</a>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <div class="switch">
                                           <label>
                                            <input type="checkbox"  onclick="return status_change('{{$v->unc_id  }}','{{ $v->sp_status }}','/status_unccat');"<?php if($status == 'Active'){ echo 'checked'; } ?> ><span class="lever switch-col-light-green"></span></label>
                                          </div>
                                          </td>
                                            <td>                                           
                                            <label for="{{$v->unc_id }}"></label>
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/editunccat')}}/{{$v->unc_id }}" class=" waves-effect waves-block">Edit</a></li>
												   <li><a  href="{{url('admin/deleteunccat').'/'.$v->unc_id }}" onClick="return confirm('Are you sure you want to delete this item?');" class=" waves-effect waves-block">Delete</a></li> 
