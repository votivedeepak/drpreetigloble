                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                              <!-- <form method="POST" id="form_validation" action="{{ url('institute/update') }}">  @csrf
                                ...
                                <a href="{{ url('admin/add_scope') }}" type="button" class="btn btn-warning waves-effect">Add Scope</a>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <div class="switch">
                                           <label>
                                            <input type="checkbox"  onclick="return status_change('{{$v->sp_id }}','{{ $v->sp_status }}','/status_scope');"<?php if($status == 'Active'){ echo 'checked'; } ?> ><span class="lever switch-col-light-green"></span></label>
                                          </div>
                                          </td>
                                            <td>                                           
                                            <label for="{{$v->sp_id}}"></label>
                                              <ul class="header-dropdown m-r--5 manegDots">
                                                <li class="dropdown" style="list-style: none;">
                                                  ...
                                                  <ul class="dropdown-menu pull-right">
                                                    <li><a href="{{url('admin/editscope')}}/{{$v->sp_id}}" class=" waves-effect waves-block">Edit</a></li>
												   <li><a  href="{{url('admin/deletescope').'/'.$v->sp_id}}" onClick="return confirm('Are you sure you want to delete this item?');" class=" waves-effect waves-block">Delete</a></li> 
