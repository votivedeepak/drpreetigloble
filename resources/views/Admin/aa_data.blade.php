...
<body class="theme-red">
                          ...
                          <?php }}else{?>
                             ...
                             <div class="col-md-12" >
                               <div class="row add-title-bar">
                                 ...
                                 <div class="col-md-6 form-group">
                                   <textarea class="form-control" name="distribution[]" placeholder="Enter Content" value="" /></textarea>
                                 </div>
                               </div>
                             </div> 
 ...
 <script>function addRow () {
  document.querySelector('#content').insertAdjacentHTML(
    ...
    <div class="col-md-6 form-group">
    <input type="text" class="form-control" name="distribution[]" placeholder="Enter Content" value="" />
    </div>
...
function removeRow (input) {
 ...
 function addRow() {
    ...
    var blocker = "ckeditor"+ckid1;
    //alert(blocker);

    document.querySelector('#content').insertAdjacentHTML('afterbegin', 
    '<div class="col-md-12" ><div class="row" ><div class="col-md-6 form-group"><input type="text" class="form-control" name="title[]" placeholder="Enter Name" value="" /></div><div class="col-md-6 form-group"><textarea class="form-control ckeditor" name="distribution[]" placeholder="Enter Content" value="" /></textarea></div><input type="button" class="btn btn-success" value="Remove" onclick="removeRow(this)"></div></div>');
     
	//   $("#content").append("<div class='col-md-12'><div class='row add-title-bar'><div class='col-md-6 form-group'><input type='text' class='form-control' name='title[]' placeholder='Enter Name' value=''/></div><div class='col-md-6 form-group'><textarea class='form-control ckeditor' id='"+blocker+"' name='distribution[]' placeholder='Enter Content' value='' /></textarea></div><input type='button' class='btn btn-success' value='Remove' onclick='removeRow(this)'></div></div>");  
...
//  $(attrWrapper).append('<div class="col-md-12"><div class="row add-title-bar"><div class="col-md-6 form-group"><input type="text" class="form-control" name="title[]" placeholder="Enter Name" value="" /></div><div class="col-md-6 form-group"><input type="text" class="form-control" name="distribution[]" placeholder="Enter Content" value="" /></div><span><a href="" class="remove_attraction_button">Remove</a></span></div></div>');
//  });
