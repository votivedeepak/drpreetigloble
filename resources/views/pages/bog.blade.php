...
<div class="col-md-12">
  <div class="course-details-1x imgs">
    <h2 style="color: #000; margin: 10px 0;"></h2>

    <p style="text-align: justify;">
      In supersession of Notification vide Ref: DPGU/2024/BOG/001 dated February 02, 2024 University is hereby re-constituted as follows:
    </p>
    ...
    <table class="table table-bordered" style="width:100%; border-collapse:collapse; margin-top: 20px;">
      ...
      <tbody>
        <tr>
          <td>1</td>
          <td><strong>Mr. Deepanshu Suhane</strong></td>
          <td>Chancellor</td>
          <td>Chairman</td>
        </tr>
        <tr>
          <td>2</td>
          <td><strong>Dr. Dileep Sharma</strong></td>
          <td>Vice-Chancellor</td>
          <td>Member</td>
        </tr>
        <tr>
          <td>3</td>
          <td><strong>Mr. Ajay Rai</strong></td>
          <td>Registrar</td>
          <td>Member</td>
        </tr>
        <tr>
          <td>4</td>
          <td><strong>Dr. Sanjeev Gupta</strong></td>
          <td>Director</td>
          <td>Member</td>
        </tr>
