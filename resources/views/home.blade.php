...
<div class="social-nt-fixed">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ url('public/frontend/assets/img/img1.jpg')}}" class="d-block w-100 " alt="" >
...
<!-- ======= Services Section ======= -->
        ...
        <div class="row ">
          <div class="col-lg-3 pt-3 col-md-6 " data-aos="fade-up" data-aos-delay="300">
            <div class="service-box orange">
              ...
              <h4>Apply Online</h4>
             <a href="{{url('global/admission-online')}}">  <p>You Can Apply Online for Admission.</p></a>
          ...
          <div class="col-lg-3 col-md-6 pt-3" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="service-box blue">
              ...
              <h4>Registration Form </h4>
                <a href="{{url('global/admission-online')}}"><p>Click For More Information.</p>
             </a>
            </div>
          </div>
          ...
          <div class="block-two pt-5">
           <div class="row ">
            ...
            <div class="service-item">
              <div class="img">
                <img src="{{ url('public/frontend/assets/img/news-media-image.png')}}" class="img-fluid" alt="">
              </div>
             ...
             <!--    <div class="icon">
                ...
                <a href="{{url('global/campuslife')}}" class="read-more"><span>View All</span> <i class="bi bi-arrow-right"></i></a>
            ...
            <div class="service-item">
              <div class="img">
                <img src="{{ url('public/frontend/assets/img/approval-image.png')}}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
               <!--  <div class="icon">
                ...
                <a href="{{ url('public/frontend/assets/pdf/2022-09-15-Ex-498.pdf')}}" class="read-more"><span>Read More</span> <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
              </div><!-- End Service Item -->
            ...
            <div class="service-item">
              <div class="img">
                <img src="{{ url('public/frontend/assets/img/en-now.png')}}" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
               <!--  <div class="icon">
                  <i class="bi bi-broadcast"></i>
                ...
                <a href="{{url('global/admission-online')}}" class="read-more"><span>Enquiry Now</span> <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
              </div><!-- End Service Item -->
            </div>
    ...
    <section id="Admission" class="Admission" data-aos="fade-up">
      <div class="container-fluid">
        ...
        <div class="btnn ">
           <a href="{{url('global/admission-online')}}" class="btn-buy">Explore</a>
        </div>
    <!--   </div>
            </div> -->
          ...
          <div class="row posts swiper-wrapper">
           <!--  <div class="owl-carousel owl-theme"> -->
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-1.jpg')}}">
                  <div class="serv-child">
                    ...
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Engineering')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-2.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Pharmacy')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-3.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Management')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-4.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Commerce')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-5.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Nursing')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-6.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Arts')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-7.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Agriculture')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-8.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Paramedical-Science')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-9.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/General-Science')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-10.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Forensic-Science')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-11.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Communication')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-12.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Physical-Education')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-13.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/LAW')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-14.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Computer-Application')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-15.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Home-Science')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-16.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/fine-Arts')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-17.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Social-Work')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
             ...
             <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-18.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Library-Science')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
             ...
             <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/dept-19.jpg')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Education')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
            ...
            <div class="col-lg-3 pt-3">
              <div class="post">
                <a href="#"><img src="{{ url('public/frontend/assets/img/embryology.png')}}">
                  <div class="serv-child">
                    <!-- <div class="thumb">
                       <img src="img/services-1.jpg">
                    </div> -->
                    <div class="post-content">
                      ...
                      <div class="desc"> 
                           <div class="btnn ">
                           <a href="{{ url('global/Embryology')}}" class="btn-more"><span>Explore</span></a>
                          </div>
                      </div>
                     </div>
                  </div>
   ...
   <div class="container">
          ...
          <div class="content d-flex flex-column justify-content-center h-100">
             <!--  <h4>Glorious Years of  Excellence and Leadership</h4>
              ...
              <div class="text-right ">
               <a href="{{url('global/about')}}" class="btn-buy">Explore</a>
              </div>
          </div>
        </div>
    </div>
          ...
          <div class=" slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 567px;"> <a href="#">
            <div class="halfimg">
              <div class="fl leftimg">
                 <img src="{{ url('public/frontend/assets/img/news-image2.jpg')}}">
          ...
          <div class=" slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 567px;"> <a href="#">
            <div class="halfimg">
              <div class="fl leftimg"> 
                    ...
                    <img src="{{ url('public/frontend/assets/img/11.jpg')}}">
              </div>
              <div class="fl halfimgright">
      ...
      <div class="swiper-slide">
         <div class=" col-lg-12 item">
          <div class=" slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 567px;"> <a href="#">
            <div class="halfimg">
              <div class="fl leftimg"> 
                 <img src="{{ url('public/frontend/assets/img/news-media-4.jpeg')}}">
              </div>
              <div class="fl halfimgright">
    ...
    <div class="swiper-slide">
          ...
          <div class=" slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 567px;"> <a href="#">
            <div class="halfimg">
              <div class="fl leftimg"> 
                <img src="{{ url('public/frontend/assets/img/media-img.jpeg')}}">
              </div>
              <div class="fl halfimgright">
      ...
      <!--   <hr> -->
        ...
        <div class="clients-slider swiper" data-aos="fade-up">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-11.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-22.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-3.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-4.png')}}" class="img-fluid" alt=""></div>

            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-11.png')}}" class="img-fluid" alt=""></div>  

            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-6.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-11.png')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-22.png')}}" class="img-fluid" alt=""></div>
             <div class="swiper-slide"><img src="{{ url('public/frontend/assets/img/company-img-3.png')}}" class="img-fluid" alt=""></div>
          </div>
    ...
    <div class="modal fade show" id="empModal" style="display: none;" aria-modal="true" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <form action="{{url('global/admissiononlinehome')}}" method="post" role="form" class="php-email-form homepoup">
              @csrf
              <div class="row">
