...
<div class="col-md-12 m-auto xc-pading padding-page-content">
    ...
    <div class="bx_fourFilter navtab-bottom">
                      ...
                      <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                ...
                                <?php } else { ?>
                      <a class="nav-item nav-link" id="nav-profile-tab_two"  href="{{ url('login') }}/{{base64_encode($unvercitydetail->unrs_id)}}/tab" role="tab" aria-controls="nav-profile_two" aria-selected="false">2. Satisfaction</a> 
                                <a class="nav-item nav-link" id="nav-home-tab_thre"  href="{{ url('login') }}/{{base64_encode($unvercitydetail->unrs_id)}}/tab" role="tab" aria-controls="nav-home_thre" aria-selected="false">3. Admission and enrollment</a>
                                <a class="nav-item nav-link" id="nav-profile-tab_for"  href="{{ url('login') }}/{{base64_encode($unvercitydetail->unrs_id)}}/tab" role="tab" aria-controls="nav-profile_for" aria-selected="false">4. Performance</a>
                                <?php } ?>
  ...
  <div class="row fcv-pading padding-page-content">
   ...
   <div class="unvirl-address">
    ...
    <!-- <a href="https://{{$unvercitydetail->univercity_url}}"> {{$unvercitydetail->univercity_url}} </a> -->
    
<!-- <a href="@if(!empty($unvercitydetail->univercity_url)){{ $unvercitydetail->univercity_url }}@else{{<?php //echo 'Not a Valid Url'; ?>}}@endif">@if(!empty($unvercitydetail->univercity_url)){{ $unvercitydetail->univercity_url }}@else{{<?php //echo 'Not a Valid Url'; ?>}}@endif</a> -->
